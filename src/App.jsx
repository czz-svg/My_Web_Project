        ...
        <div className="links">
          ...
          <div className='dropdown'>
            ...
            <div className='dropdown-content'>
              <NavLink to="/features/quiz" className="link">Quiz</NavLink>
              <NavLink to="/features/clock" className="link">Clock</NavLink>
              <NavLink to="/features/weather" className="link">Weather</NavLink>
              <NavLink to="/features/random" className="link">Random</NavLink>
            </div>
          </div>
